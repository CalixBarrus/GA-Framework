...
def main():
    ...
    population_size = 10
    population = ByteGenotype.generate_random_population(population_size, len(string_to_find))
    ...
    managers = [simple_manager, truncation_manager, brute_force_manager, simple_meiosis_manager, multiple_children_manager, diversity_manager, tournament_manager]
